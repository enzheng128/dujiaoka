            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body p-4">
                  ...
                  <h6>
                    <small
                      class="text-muted">{{__('goods.fields.in_stock')}}：{{ $is_hide_stock ? ($in_stock > 10 ? __('goods.fields.high') : ($in_stock === 0 ? __('goods.fields.none') : __('goods.fields.low'))) : $in_stock }}</small>
                  </h6>
                  @if($buy_limit_num > 0)
                    ...
                    <form action="{{ url('create-order') }}" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-md-6">
                          ...
                          <input type="email" class="form-control form-control-sm" name="email" id="email" required
                            placeholder="{{ __('dujiaoka.email') }}">
                        </div>
                        <div class="col-xs-12 col-md-4">
                          <label for="shop-number" class="col-form-label">{{ __('dujiaoka.by_amount') }}:</label>
                          <input type="number" class="form-control form-control-sm" id="shop-number" name="by_amount"
                            placeholder="" min="1" value="1">
                        </div>
                        @if(isset($open_coupon))
                        <div class="col-xs-12 col-md-6">
                          <label for="coupon" class="col-form-label">{{ __('dujiaoka.coupon_code') }}:</label>
                          <input type="text" class=" control form-control form-control-sm" id="coupon"
                        ...
                        <div class="col-xs-12 col-md-6">
                          ...
                          <input type="text" class=" control form-control form-control-sm" id="search_pwd"
                            name="search_pwd" required placeholder="" value="">
                        </div>
                        @endif
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group">
                            ...
                            <script>
                            function refresh() {
                              $('#imageCode').attr('src', '{{ captcha_src('
                                buy ') }}' + Math.random());
                            }
                            </script>
                          </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-md-6">
                          ...
                          <input type="text" class=" control form-control form-control-sm" id="{{ $ipu['field'] }}"
                            name="{{ $ipu['field'] }}" @if($ipu['rule'] !==false) required @endif
                          ...
                          <fieldset>
                            ...
                            <div class="form-check form-check-inline">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="payway" value="{{ $way['id'] }}"
