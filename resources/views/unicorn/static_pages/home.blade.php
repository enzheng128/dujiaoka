        ...
        <div class="col-md-12">
          <div class="category-menus">
            <ul class="nav nav-pills  justify-content-center">
              <li class="nav-item">
                <a href="#group-all" data-bs-toggle="tab"
                  class="btn btn-outline-secondary active">{{ __('dujiaoka.group_all') }}</a>
              </li>
              @foreach($data as $index => $group)
              <li class="nav-item">
                <a href="#group-{{ $group['id'] }}" data-bs-toggle="tab"
                  class="btn btn-outline-secondary">{{ $group['gp_name'] }}</a>
              </li>
              @endforeach
            </ul>
          </div>
              ...
              <div class="col">
                <div class="card position-relative">
                  ...
                  <div class="card-body">
                    ...
                    @endif
                    <h6 class="mt-2"><small
                        class="text-muted">{{__('goods.fields.in_stock')}}：{{ $goods['is_hide_stock'] ? ($goods['in_stock'] > 10 ? __('goods.fields.high') : ($goods['in_stock'] === 0 ? __('goods.fields.none') : __('goods.fields.low'))) : $goods['in_stock'] }}</small>
                    </h6>
